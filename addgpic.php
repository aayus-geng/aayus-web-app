...
<?php } ?>
			...
			if(!isset($gcat)){
			?>
				<h3>Select a category or <a href="addgpic2.php" class="btntopup btn-round">click</a> here to upload your own</h3><br><br>	
			<?php	
			  $STMgcat1 = $dbh->prepare("SELECT * FROM lut_goalcat");

					$STMgcat1->execute();

					$STMgoalcat1 = $STMgcat1->fetchAll();
					foreach($STMgoalcat1 as $goalcat1)
			  ...
			  <div class="col-sm-4" align="center">
				<a href="addgpic.php?gcat=<?php echo $goalcat1['goal_cat'];?>">
				
				<button type="button" class="btntopup btn-round" style="display: block; width: 100%;"><img src="img/goals/<?php echo $goalcat1['goalcat_img'];?>" width="auto" height="80"><br><?php echo $goalcat1['goal_cat_name'];?><br></button>
				</a>
				</div>
			  <?php }} ?>
			  ...
			  <?php
				...
				?>
			  <h3>Select an Image or <a href="addgpic2.php" class="btntopup btn-round">click</a> here to upload your own.  </h3><br><br>	
			  ...
			  $STMgimg1 = $dbh->prepare("SELECT * FROM lut_goalimg WHERE goalimg_cat='$gcat' ORDER BY rand()");
			  ...
			  <a href="addgpic2.php?gpid=<?php echo $goalimg1['goalimg_id'];?>">
			  <img src="img/goals/<?php echo $goalimg1['goalimg_cat']."/".$goalimg1['goalimg_file'];?>" alt="<?php echo $goalimg1['goalimg_name'];?>"></a>
