...
<?php } ?>
			...
			if(isset($gpid)){
			  ...
			  $STMgimg1 = $dbh->prepare("SELECT * FROM lut_goalimg WHERE goalimg_id='$gpid'");
			  ...
			  ?>
			   <form action="db_goalbrdpic.php" method="post" name="formaddgpic1" class="style1" id="formaddgpic1">
			   
			   
			  <img src="img/goals/<?php echo $goalimg1['goalimg_cat']."/".$goalimg1['goalimg_file'];?>" alt="<?php echo $goalimg1['goalimg_name'];?>" width="auto" height="300" >
			  <br><br>
			
				<input type="hidden" name="goal_img" id="goal_img" value="img/goals/<?php echo $goalimg1['goalimg_cat']."/".$goalimg1['goalimg_file'];?>"/>
			  ...
			  <form enctype="multipart/form-data" action="db_goalbrdpic2.php" method="post" name="formaddgpic2" class="style1" id="formaddgpic2">
				...
				<input type="hidden" name="usrid" id="usrid" value="<?php echo $userida;?>"/>
				<input type="submit" name="add" id="add" class="btntopup btn-round" value="Add">
