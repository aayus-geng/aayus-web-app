      ...
      <div class="widget-content">
			...
			<section id="photos">
			  ...
			  $STMgimg1 = $dbh->prepare("SELECT goal_id, gimage, usrid FROM tbl_goal WHERE usrid='$userida'");
				...
				{
			  ?>
			  <a href="mygoal.php?goalid=<?php echo $goalimg1['goal_id'];?>">
			  <img src="<?php echo $goalimg1['gimage'];?>" alt=""></a>
			  ...
			  $STMgimg1a = $dbh->prepare("SELECT goalboard_id, goal_img, usrid FROM tbl_goalbrd WHERE usrid='$userida'");
				...
				{
			  ?>
			  <a href="addgpic.php?gpid=<?php echo $goalimg1a['goalboard_id'];?>">
			  <img src="<?php echo $goalimg1a['goal_img'];?>" alt=""></a>
