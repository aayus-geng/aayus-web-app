...
<?php } ?>
			...
			<br><br><br>
			<h3>Select an Image or <a href="goalsc.php?gcat=<?php echo $gcat;?>" class="btn btn-default">click</a> here to add your goal then upload an image of your own. </h3>
			  <section id="photos">
			...
			<a href="goalsc.php?gpid=<?php echo $goalimg1['goalimg_id'];?>">
