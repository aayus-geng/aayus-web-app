			...
			foreach($STMgoalimg1 as $goalimg1)
			  ...
			  <form enctype="multipart/form-data" action="db_goal.php" method="post" name="formaddgpic" class="style1" id="formaddgpic">
				...
				<br>
					...
					?>
					<input type="hidden" name="goalimg" id="goalimg" value="img/goals/<?php echo $goalimg1['goalimg_cat']."/".$goalimg1['goalimg_file'];?>"/>
					
					<?php } else { ?>
					<input type="hidden" name="noimg" id="noimg" value=""/>
					<?php } ?>
				</div>
				<br>
				<div class="form-group">
				...
				<div class="form-group">
				<input id="vibe1" name="gvibe" data-slider-id='ex1Slider' type="text" data-slider-min="0" data-slider-max="10" data-slider-step="1" data-slider-value="5"/>
				</div>
				<br><br>
				<div class="form-group">
