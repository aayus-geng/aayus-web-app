...
<div class="all-wrapper no-menu-wrapper light-bg">
  <div class="login-logo-w">
	...
	<img src="img/snaplogo1.png" alt="B2S" width="280" height="180" /></div>
  <div class="row">
        ...
        <div class="widget-content">
          <form action="checklogin.php" method="POST" id="login-form" class="cmxform">
            ...
            <div class="form-group relative-w">
              <input name="username" type="text" autofocus class="round full-width-input" id="login-username" placeholder=" User" size="45"  />
              
            </div>
            <div class="form-group relative-w">
              <input name="password" type="password" class="round full-width-input" id="login-password" placeholder=" Password" size="45"  />
              
            </div>
           <div class="form-group" align="right">
		   
            <input type="submit" class="btn btn-primary btn-rounded btn-iconed" name="submit" value="ลงทะเบียน" />
