...
<?php } ?>
			...
			<div class="col-md-6" align="center">
				...
				<table class="table table-striped" border="2">
					...
					<td align="left" width="20%"><strong>Start Date</strong></td>
				...
				<?php //$gddate1=strtotime($goal['gduedate']); echo date("M d", $gddate1);?>
					<td align="centered"><?php $gsdate1=strtotime($goals['gsstartdate']); echo date("M-d",$gsdate1);?></td>
					<td align="centered"><?php $gsdate2=strtotime($goals['gsduedate']); echo date("M-d",$gsdate2);?></td>
					...
					<a href="#addgs" data-toggle="modal" data-placement="right"  class="btntopup" title="addgs">+ Goal Step</a>
					<a href="goalview.php?goalid=<?php echo $goalid;?>" class="btntopup" title="addgs">View Timeline</a>
			  ...
			  <label class="btn btn-primary">
				...
				<div class="form-group">
                  <br><br>
					...
					Step Due Date<br>
					<input type="date" class="form-control" id="gsduedate" name="gsduedate" placeholder="Step Due Date" value="<?php print date("Y-m-d",time() + (14 * 3600));?>"/>
