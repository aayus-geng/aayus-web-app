...
<div class="modal-header">
    ...
    <h5 class="modal-title">Time Zone - <?php echo $usr;?></h5>
...
<div class="modal-body">
			<div align="center">
				...
				<div class="form-group">
					...
					<select class="auth-input form-control" id="timezone" name="timezone">
    ...
    <option value="Pacific/Tongatapu">(UTC+13:00) Nuku'alofa</option>
				...
				<div class="form-group">
				<input type="hidden" name="uid" id="uid" value="<?php echo $usr;?>">
				<input type="submit" name="tzone" id="tzone" class="btn btn-primary" value="Save">
